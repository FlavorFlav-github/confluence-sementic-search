...
LLM_BACKEND_TYPE_GENERATION="pleias-rag-350m"
LLM_MODEL_GENERATION="transformers"

LLM_BACKEND_TYPE_REFINEMENT="gemini"
LLM_MODEL_REFINE="flash"

LLM_MAX_TOKEN_GENERATION = 10000
LLM_TEMP_GENERATION = 0.2

LLM_MAX_TOKEN_REFINEMENT = 8096
LLM_TEMP_REFINEMENT = 0.4
